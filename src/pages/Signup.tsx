...
import { Mail, ArrowRight, Sparkles, BookOpen, Check } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="orb orb-indigo w-[500px] h-[500px] -top-40 -right-40" />
        <div className="orb orb-blue w-[400px] h-[400px] bottom-0 left-0" style={{ animationDelay: "-2s" }} />
        <div className="orb orb-emerald w-[300px] h-[300px] top-1/3 left-1/3" style={{ animationDelay: "-4s" }} />
      </div>
            ...
            {!isSent ? (
              <>
                <div className="text-center mb-8">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-neon-emerald/10 border border-neon-emerald/30 mb-4 animate-pulse-neon">
                    <Sparkles className="w-3.5 h-3.5 text-neon-emerald" />
                    <span className="text-xs font-medium text-neon-emerald">Essai gratuit</span>
                  </div>
                  <h1 className="text-3xl font-bold tracking-tighter mb-2">Créez votre compte</h1>
                  <p className="text-muted-foreground text-sm">Commencez à créer vos ebooks en 2 minutes</p>
                </div>
                ...
                <div className="space-y-2 mb-6">
                  {features.map((feature, i) => (
                    <div key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
                      <div className="w-5 h-5 rounded-full bg-neon-indigo/20 border border-neon-indigo/30 flex items-center justify-center">
                ...
                <p className="text-center text-sm text-muted-foreground mt-6">
                  Déjà un compte ?{" "}
                  <Link to="/login" className="text-neon-indigo hover:text-neon-blue transition-colors">
                    Se connecter
                  </Link>
                </p>
              </>
